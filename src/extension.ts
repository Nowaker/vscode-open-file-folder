...
export function activate(context: vscode.ExtensionContext) {
    ...
    const openFileCommand = vscode.commands.registerCommand('vscode-open-file-folder.openFileParentFolderAsWorkspace', async (resourceUri: vscode.Uri) => {
        try {
    ...
    const openFileRealpathCommand = vscode.commands.registerCommand('vscode-open-file-folder.openFileRealpathParentFolderAsWorkspace', async (resourceUri: vscode.Uri) => {
        try {
    ...
    const openFolderCommand = vscode.commands.registerCommand('vscode-open-file-folder.openFolderAsWorkspace', async (resourceUri: vscode.Uri) => {
        try {
