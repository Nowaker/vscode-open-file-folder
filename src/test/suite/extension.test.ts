...
suite('Extension Test Suite', () => {
  ...
  test('openRealpathDirectory should handle relative symlinks correctly', async () => {
    ...
    assert.strictEqual(
      result,
      tempDir,
      'Should resolve relative symlink to correct target directory'
    );
  ...
  test('openRealpathDirectory should handle broken symlinks gracefully', async () => {
    ...
    assert.strictEqual(
      result,
      tempDir,
      "Should fallback to symlink's directory for broken symlinks"
    );
  ...
  test('Dual symlink functionality - different behaviors', async () => {
    ...
    assert.strictEqual(
      realpathDirResult,
      sourceDir,
      "Should return target file's parent directory"
    );
    ...
    assert.notStrictEqual(
      symlinkDirResult,
      realpathDirResult,
      'Symlink and realpath directories should be different'
    );
